...
use hmac::{Hmac, Mac};
use shared_types::heed::BoxedError;
use shared_types::index_uid_pattern::IndexUidPattern;
use shared_types::keys::KeyId;
use shared_types::search_engine;
use shared_types::search_engine::heed::types::{Bytes, DecodeIgnore, SerdeJson};
use shared_types::search_engine::heed::{Database, Env, EnvOpenOptions, RwTxn};
use sha2::Sha256;
use thiserror::Error;
...
pub fn open_auth_store_env(path: &Path) -> search_engine::heed::Result<search_engine::heed::Env> {
...
impl<'a> search_engine::heed::BytesDecode<'a> for KeyIdActionCodec {
...
impl<'a> search_engine::heed::BytesEncode<'a> for KeyIdActionCodec {
