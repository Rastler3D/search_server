...
pub use shared_types::search_engine;
...
pub type Settings<T> = shared_types::settings::Settings<T>;
pub type Checked = shared_types::settings::Checked;
pub type Unchecked = shared_types::settings::Unchecked;

pub type Task = crate::TaskDump;
pub type Key = shared_types::keys::Key;
pub type RuntimeTogglableFeatures = shared_types::features::RuntimeTogglableFeatures;

// ===== Other types to clarify the code of the compat module
// everything related to the tasks
pub type Status = shared_types::tasks::Status;
pub type Kind = crate::KindDump;
pub type Details = shared_types::tasks::Details;

// everything related to the settings
pub type Setting<T> = shared_types::search_engine::update::Setting<T>;
pub type TypoTolerance = shared_types::settings::TypoSettingsView;
pub type SplitJoin = shared_types::settings::SplitJoinSettingsView;
pub type Analyzer = shared_types::settings::AnalyzerSettings;
pub type FacetingSettings = shared_types::settings::FacetingSettings;
pub type PaginationSettings = shared_types::settings::PaginationSettings;

// everything related to the api keys
pub type Action = shared_types::keys::Action;
pub type IndexUidPattern = shared_types::index_uid_pattern::IndexUidPattern;

// everything related to the errors
pub type ResponseError = shared_types::error::ResponseError;
pub type Code = shared_types::error::Code;
pub type RankingRuleView = shared_types::settings::RankingRuleView;
...
impl V1Reader {
    ...
    pub fn indexes(&self) -> Result<Box<dyn Iterator<Item = Result<V1IndexReader>> + '_>> {
