...
use shared_types::settings::Unchecked;
use shared_types::tasks::{Details, IndexSwap, KindWithContent, Status, Task, TaskId};
use shared_types::InstanceUid;
...
const CURRENT_DUMP_VERSION: Version = Version::V1;
...
pub enum KindDump {
    ...
    Settings {
        settings: Box<shared_types::settings::Settings<Unchecked>>,
        is_deletion: bool,
        allow_index_creation: bool,
    },
    IndexDeletion,
...
pub(crate) mod test {
    ...
    use shared_types::index_uid_pattern::IndexUidPattern;
    use shared_types::keys::{Action, Key};
    use shared_types::search_engine;
    use shared_types::search_engine::update::Setting;
    use shared_types::settings::{Checked, FacetingSettings, Settings};
    use shared_types::tasks::{Details, Status};
    ...
    pub fn create_test_settings() -> Settings<Checked> {
        let settings = Settings {
            ...
            analyzers: Setting::NotSet,
            split_join: Setting::NotSet,
            ...
            (
                TaskDump {
                    ...
                    kind: KindDump::DocumentImport {
                        method: search_engine::update::IndexDocumentsMethod::UpdateDocuments,
    ...
    fn test_creating_and_read_dump() {
        ...
        assert_eq!(dump.version(), Version::V1);
