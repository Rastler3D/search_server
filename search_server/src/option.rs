...
use clap::Parser;
use shared_types::features::InstanceTogglableFeatures;
...
use url::Url;
use shared_types::search_engine::ThreadPoolNoAbortBuilder;

const POSSIBLE_ENV: [&str; 2] = ["development", "production"];

const SEARCH_SYSTEM_DB_PATH: &str = "SEARCH_SYSTEM_DB_PATH";
const SEARCH_SYSTEM_HTTP_ADDR: &str = "SEARCH_SYSTEM_HTTP_ADDR";
const SEARCH_SYSTEM_MASTER_KEY: &str = "SEARCH_SYSTEM_MASTER_KEY";
const SEARCH_SYSTEM_ENV: &str = "SEARCH_SYSTEM_ENV";
const SEARCH_SYSTEM_TASK_WEBHOOK_URL: &str = "SEARCH_SYSTEM_TASK_WEBHOOK_URL";
const SEARCH_SYSTEM_TASK_WEBHOOK_AUTHORIZATION_HEADER: &str = "SEARCH_SYSTEM_TASK_WEBHOOK_AUTHORIZATION_HEADER";
#[cfg(feature = "analytics")]
const SEARCH_SYSTEM_NO_ANALYTICS: &str = "SEARCH_SYSTEM_NO_ANALYTICS";
const SEARCH_SYSTEM_HTTP_PAYLOAD_SIZE_LIMIT: &str = "SEARCH_SYSTEM_HTTP_PAYLOAD_SIZE_LIMIT";
const SEARCH_SYSTEM_SSL_CERT_PATH: &str = "SEARCH_SYSTEM_SSL_CERT_PATH";
const SEARCH_SYSTEM_SSL_KEY_PATH: &str = "SEARCH_SYSTEM_SSL_KEY_PATH";
const SEARCH_SYSTEM_SSL_AUTH_PATH: &str = "SEARCH_SYSTEM_SSL_AUTH_PATH";
const SEARCH_SYSTEM_SSL_OCSP_PATH: &str = "SEARCH_SYSTEM_SSL_OCSP_PATH";
const SEARCH_SYSTEM_SSL_REQUIRE_AUTH: &str = "SEARCH_SYSTEM_SSL_REQUIRE_AUTH";
const SEARCH_SYSTEM_SSL_RESUMPTION: &str = "SEARCH_SYSTEM_SSL_RESUMPTION";
const SEARCH_SYSTEM_SSL_TICKETS: &str = "SEARCH_SYSTEM_SSL_TICKETS";
const SEARCH_SYSTEM_IMPORT_SNAPSHOT: &str = "SEARCH_SYSTEM_IMPORT_SNAPSHOT";
const SEARCH_SYSTEM_IGNORE_MISSING_SNAPSHOT: &str = "SEARCH_SYSTEM_IGNORE_MISSING_SNAPSHOT";
const SEARCH_SYSTEM_IGNORE_SNAPSHOT_IF_DB_EXISTS: &str = "SEARCH_SYSTEM_IGNORE_SNAPSHOT_IF_DB_EXISTS";
const SEARCH_SYSTEM_SNAPSHOT_DIR: &str = "SEARCH_SYSTEM_SNAPSHOT_DIR";
const SEARCH_SYSTEM_SCHEDULE_SNAPSHOT: &str = "SEARCH_SYSTEM_SCHEDULE_SNAPSHOT";
const SEARCH_SYSTEM_IMPORT_DUMP: &str = "SEARCH_SYSTEM_IMPORT_DUMP";
const SEARCH_SYSTEM_IGNORE_MISSING_DUMP: &str = "SEARCH_SYSTEM_IGNORE_MISSING_DUMP";
const SEARCH_SYSTEM_IGNORE_DUMP_IF_DB_EXISTS: &str = "SEARCH_SYSTEM_IGNORE_DUMP_IF_DB_EXISTS";
const SEARCH_SYSTEM_DUMP_DIR: &str = "SEARCH_SYSTEM_DUMP_DIR";
const SEARCH_SYSTEM_LOG_LEVEL: &str = "SEARCH_SYSTEM_LOG_LEVEL";
const SEARCH_SYSTEM_EXPERIMENTAL_LOGS_MODE: &str = "SEARCH_SYSTEM_EXPERIMENTAL_LOGS_MODE";
const SEARCH_SYSTEM_EXPERIMENTAL_REPLICATION_PARAMETERS: &str = "SEARCH_SYSTEM_EXPERIMENTAL_REPLICATION_PARAMETERS";
const SEARCH_SYSTEM_EXPERIMENTAL_ENABLE_LOGS_ROUTE: &str = "SEARCH_SYSTEM_EXPERIMENTAL_ENABLE_LOGS_ROUTE";
const SEARCH_SYSTEM_EXPERIMENTAL_ENABLE_METRICS: &str = "SEARCH_SYSTEM_EXPERIMENTAL_ENABLE_METRICS";
const SEARCH_SYSTEM_EXPERIMENTAL_SEARCH_QUEUE_SIZE: &str = "SEARCH_SYSTEM_EXPERIMENTAL_SEARCH_QUEUE_SIZE";
const SEARCH_SYSTEM_EXPERIMENTAL_REDUCE_INDEXING_MEMORY_USAGE: &str =
    "SEARCH_SYSTEM_EXPERIMENTAL_REDUCE_INDEXING_MEMORY_USAGE";
const SEARCH_SYSTEM_EXPERIMENTAL_MAX_NUMBER_OF_BATCHED_TASKS: &str =
    "SEARCH_SYSTEM_EXPERIMENTAL_MAX_NUMBER_OF_BATCHED_TASKS";
...
const SEARCH_SYSTEM_MAX_INDEXING_MEMORY: &str = "SEARCH_SYSTEM_MAX_INDEXING_MEMORY";
const SEARCH_SYSTEM_MAX_INDEXING_THREADS: &str = "SEARCH_SYSTEM_MAX_INDEXING_THREADS";
...
pub struct Opt {
    ...
    #[clap(long, env = SEARCH_SYSTEM_DB_PATH, default_value_os_t = default_db_path())]
    #[serde(default = "default_db_path")]
    pub db_path: PathBuf,

    /// Sets the HTTP address and port Meilisearch will use.
    #[clap(long, env = SEARCH_SYSTEM_HTTP_ADDR, default_value_t = default_http_addr())]
    #[serde(default = "default_http_addr")]
    pub http_addr: String,

    /// Sets the instance's master key, automatically protecting all routes except `GET /health`.
    #[clap(long, env = SEARCH_SYSTEM_MASTER_KEY)]
    pub master_key: Option<String>,

    /// Configures the instance's environment. Value must be either `production` or `development`.
    #[clap(long, env = SEARCH_SYSTEM_ENV, default_value_t = default_env(), value_parser = POSSIBLE_ENV)]
    #[serde(default = "default_env")]
    pub env: String,

    /// Called whenever a task finishes so a third party can be notified.
    #[clap(long, env = SEARCH_SYSTEM_TASK_WEBHOOK_URL)]
    ...
    #[clap(long, env = SEARCH_SYSTEM_TASK_WEBHOOK_AUTHORIZATION_HEADER)]
    ...
    #[clap(long, env = SEARCH_SYSTEM_NO_ANALYTICS)]
    ...
    /// base unit (for instance: 107374182400, '107.7Gb', or '107374 Mb').
    #[clap(long, env = SEARCH_SYSTEM_HTTP_PAYLOAD_SIZE_LIMIT, default_value_t = default_http_payload_size_limit())]
    #[serde(default = "default_http_payload_size_limit")]
    pub http_payload_size_limit: Byte,

    /// Sets the server's SSL certificates.
    #[clap(long, env = SEARCH_SYSTEM_SSL_CERT_PATH, value_parser)]
    pub ssl_cert_path: Option<PathBuf>,

    /// Sets the server's SSL key files.
    #[clap(long, env = SEARCH_SYSTEM_SSL_KEY_PATH, value_parser)]
    pub ssl_key_path: Option<PathBuf>,

    /// Enables client authentication in the specified path.
    #[clap(long, env = SEARCH_SYSTEM_SSL_AUTH_PATH, value_parser)]
    pub ssl_auth_path: Option<PathBuf>,

    /// Sets the server's OCSP file. *Optional*
    ///
    /// Reads DER-encoded OCSP response from OCSPFILE and staple to certificate.
    #[clap(long, env = SEARCH_SYSTEM_SSL_OCSP_PATH, value_parser)]
    pub ssl_ocsp_path: Option<PathBuf>,

    /// Makes SSL authentication mandatory.
    #[serde(default)]
    #[clap(long, env = SEARCH_SYSTEM_SSL_REQUIRE_AUTH)]
    pub ssl_require_auth: bool,

    /// Activates SSL session resumption.
    #[serde(default)]
    #[clap(long, env = SEARCH_SYSTEM_SSL_RESUMPTION)]
    pub ssl_resumption: bool,

    /// Activates SSL tickets.
    #[serde(default)]
    #[clap(long, env = SEARCH_SYSTEM_SSL_TICKETS)]
    pub ssl_tickets: bool,

    /// Launches Meilisearch after importing a previously-generated snapshot at the given filepath.
    #[clap(long, env = SEARCH_SYSTEM_IMPORT_SNAPSHOT)]
    ...
    #[clap(
        long,
        env = SEARCH_SYSTEM_IGNORE_MISSING_SNAPSHOT,
    ...
    #[clap(
        long,
        env = SEARCH_SYSTEM_IGNORE_SNAPSHOT_IF_DB_EXISTS,
        requires = "import_snapshot"
    )]
    #[serde(default)]
    ...
    #[clap(long, env = SEARCH_SYSTEM_SNAPSHOT_DIR, default_value_os_t = default_snapshot_dir())]
    ...
    #[clap(long,env = SEARCH_SYSTEM_SCHEDULE_SNAPSHOT, num_args(0..=1), value_parser=parse_schedule_snapshot, default_value_t, default_missing_value=default_snapshot_interval_sec(),  value_name = "SNAPSHOT_INTERVAL_SEC")]
    ...
    #[clap(long, env = SEARCH_SYSTEM_IMPORT_DUMP, conflicts_with = "import_snapshot")]
    ...
    #[clap(long, env = SEARCH_SYSTEM_IGNORE_MISSING_DUMP, requires = "import_dump")]
    #[serde(default)]
    ...
    ///
    /// This option will trigger an error if `--import-dump` is not defined.
    #[clap(long, env = SEARCH_SYSTEM_IGNORE_DUMP_IF_DB_EXISTS, requires = "import_dump")]
    #[serde(default)]
    pub ignore_dump_if_db_exists: bool,

    /// Sets the directory where Meilisearch will create dump files.
    #[clap(long, env = SEARCH_SYSTEM_DUMP_DIR, default_value_os_t = default_dump_dir())]
    ...
    #[clap(long, env = SEARCH_SYSTEM_LOG_LEVEL, default_value_t)]
    #[serde(default)]
    ...
    #[clap(long, env = SEARCH_SYSTEM_EXPERIMENTAL_ENABLE_METRICS)]
    #[serde(default)]
    ...
    #[clap(long, env = SEARCH_SYSTEM_EXPERIMENTAL_SEARCH_QUEUE_SIZE, default_value_t = 1000)]
    #[serde(default)]
    ...
    #[clap(long, env = SEARCH_SYSTEM_EXPERIMENTAL_LOGS_MODE, default_value_t)]
    #[serde(default)]
    ...
    #[clap(long, env = SEARCH_SYSTEM_EXPERIMENTAL_ENABLE_LOGS_ROUTE)]
    #[serde(default)]
    ...
    #[clap(long, env = SEARCH_SYSTEM_EXPERIMENTAL_REPLICATION_PARAMETERS)]
    #[serde(default)]
    pub experimental_replication_parameters: bool,

    /// Experimental RAM reduction during indexing, do not use in production, see: <https://github.com/meilisearch/product/discussions/652>
    #[clap(long, env = SEARCH_SYSTEM_EXPERIMENTAL_REDUCE_INDEXING_MEMORY_USAGE)]
    #[serde(default)]
    ...
    #[clap(long, env = SEARCH_SYSTEM_EXPERIMENTAL_MAX_NUMBER_OF_BATCHED_TASKS, default_value_t = default_limit_batched_tasks())]
...
impl Opt {
    ...
    pub fn try_build() -> anyhow::Result<(Self, Option<PathBuf>)> {
        ...
        let user_specified_config_file_path = opts
            .config_file_path
            .clone()
            .or_else(|| env::var("SEARCH_SYSTEM_CONFIG_FILE_PATH").map(PathBuf::from).ok());
    ...
    fn export_to_env(self) {
        ...
        export_to_env_if_not_present(SEARCH_SYSTEM_DB_PATH, db_path);
        export_to_env_if_not_present(SEARCH_SYSTEM_HTTP_ADDR, http_addr);
        if let Some(master_key) = master_key {
            export_to_env_if_not_present(SEARCH_SYSTEM_MASTER_KEY, master_key);
        }
        export_to_env_if_not_present(SEARCH_SYSTEM_ENV, env);
        if let Some(task_webhook_url) = task_webhook_url {
            export_to_env_if_not_present(SEARCH_SYSTEM_TASK_WEBHOOK_URL, task_webhook_url.to_string());
        }
        if let Some(task_webhook_authorization_header) = task_webhook_authorization_header {
            export_to_env_if_not_present(
                SEARCH_SYSTEM_TASK_WEBHOOK_AUTHORIZATION_HEADER,
                task_webhook_authorization_header,
            );
        }
        ...
        #[cfg(feature = "analytics")]
        {
            export_to_env_if_not_present(SEARCH_SYSTEM_NO_ANALYTICS, no_analytics.to_string());
        }
        export_to_env_if_not_present(
            SEARCH_SYSTEM_HTTP_PAYLOAD_SIZE_LIMIT,
        ...
        if let Some(ssl_cert_path) = ssl_cert_path {
            export_to_env_if_not_present(SEARCH_SYSTEM_SSL_CERT_PATH, ssl_cert_path);
        }
        if let Some(ssl_key_path) = ssl_key_path {
            export_to_env_if_not_present(SEARCH_SYSTEM_SSL_KEY_PATH, ssl_key_path);
        }
        if let Some(ssl_auth_path) = ssl_auth_path {
            export_to_env_if_not_present(SEARCH_SYSTEM_SSL_AUTH_PATH, ssl_auth_path);
        }
        if let Some(ssl_ocsp_path) = ssl_ocsp_path {
            export_to_env_if_not_present(SEARCH_SYSTEM_SSL_OCSP_PATH, ssl_ocsp_path);
        }
        export_to_env_if_not_present(SEARCH_SYSTEM_SSL_REQUIRE_AUTH, ssl_require_auth.to_string());
        export_to_env_if_not_present(SEARCH_SYSTEM_SSL_RESUMPTION, ssl_resumption.to_string());
        export_to_env_if_not_present(SEARCH_SYSTEM_SSL_TICKETS, ssl_tickets.to_string());
        export_to_env_if_not_present(SEARCH_SYSTEM_SNAPSHOT_DIR, snapshot_dir);
        if let Some(snapshot_interval) = schedule_snapshot_to_env(schedule_snapshot) {
            export_to_env_if_not_present(SEARCH_SYSTEM_SCHEDULE_SNAPSHOT, snapshot_interval)
        }

        export_to_env_if_not_present(SEARCH_SYSTEM_DUMP_DIR, dump_dir);
        export_to_env_if_not_present(SEARCH_SYSTEM_LOG_LEVEL, log_level.to_string());
        export_to_env_if_not_present(
            SEARCH_SYSTEM_EXPERIMENTAL_ENABLE_METRICS,
            experimental_enable_metrics.to_string(),
        );
        export_to_env_if_not_present(
            SEARCH_SYSTEM_EXPERIMENTAL_SEARCH_QUEUE_SIZE,
            experimental_search_queue_size.to_string(),
        );
        export_to_env_if_not_present(
            SEARCH_SYSTEM_EXPERIMENTAL_LOGS_MODE,
            experimental_logs_mode.to_string(),
        );
        export_to_env_if_not_present(
            SEARCH_SYSTEM_EXPERIMENTAL_REPLICATION_PARAMETERS,
            experimental_replication_parameters.to_string(),
        );
        export_to_env_if_not_present(
            SEARCH_SYSTEM_EXPERIMENTAL_ENABLE_LOGS_ROUTE,
...
pub struct IndexerOpts {
    ...
    #[clap(long, env = SEARCH_SYSTEM_MAX_INDEXING_MEMORY, default_value_t)]
    #[serde(default)]
    ...
    #[clap(long, env = SEARCH_SYSTEM_MAX_INDEXING_THREADS, default_value_t)]
    #[serde(default)]
...
impl IndexerOpts {
    ...
    pub fn export_to_env(self) {
        ...
        if let Some(max_indexing_memory) = max_indexing_memory.0 {
            export_to_env_if_not_present(
                SEARCH_SYSTEM_MAX_INDEXING_MEMORY,
                max_indexing_memory.to_string(),
            );
        }
        export_to_env_if_not_present(
            SEARCH_SYSTEM_MAX_INDEXING_THREADS,
...
mod test {
    ...
    fn test_meilli_config_file_path_valid() {
        temp_env::with_vars(
            vec![("SEARCH_SYSTEM_CONFIG_FILE_PATH", Some("../config.toml"))], // Relative path in meilisearch package
            || {
    ...
    fn test_meilli_config_file_path_invalid() {
        temp_env::with_vars(vec![("SEARCH_SYSTEM_CONFIG_FILE_PATH", Some("../configgg.toml"))], || {
