...
use shared_types::deserr::{immutable_field_error, DeserrJsonError, DeserrQueryParamError};
use shared_types::error::deserr_codes::*;
use shared_types::error::{Code, ResponseError};
use shared_types::index_uid::IndexUid;
use shared_types::search_engine::{self, FieldDistribution, Index};
...
impl IndexView {
    fn new(uid: String, index: &Index) -> Result<IndexView, search_engine::Error> {
