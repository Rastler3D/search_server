...
use shared_types::heed::types::{SerdeJson, Str};
use shared_types::heed::{Database, Env, RoTxn, RwTxn};
use shared_types::search_engine::update::IndexerConfig;
use shared_types::search_engine::{FieldDistribution, Index};
    ...
    pub fn create_index(
        ...
        match self.index(&wtxn, name) {
            ...
            Err(Error::IndexNotFound(_)) => {
                ...
                // TODO: it would be better to lazily create the index. But we need an Index::open function for search_engine.
